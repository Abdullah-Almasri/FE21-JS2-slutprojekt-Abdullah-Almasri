 ...
 */
(0,s("9RI9r").registerVersion)("firebase","9.22.1","app")})),s.register("9RI9r",(function(t,n){e(t.exports,"_registerComponent",(()=>m)),e(t.exports,"_getProvider",(()=>y)),e(t.exports,"SDK_VERSION",(()=>b)),e(t.exports,"initializeApp",(()=>I)),e(t.exports,"getApp",(()=>E)),e(t.exports,"registerVersion",(()=>T));var i=s("24lia"),r=s("4juNA"),o=s("hOThH"),a=(o=s("hOThH"),s("DQqmO"));
/**
 * @license
 ...
 * limitations under the License.
 */
const S="firebase-heartbeat-database",k=1,N="firebase-heartbeat-store";let x=null;function P(){return x||(x=(0,a.openDB)(S,k,{upgrade:(e,t)=>{if(0===t)e.createObjectStore(N)}}).catch((e=>{throw C.create("idb-open",{originalErrorMessage:e.message})}))),x}async function D(e,t){try{const n=(await P()).transaction(N,"readwrite"),i=n.objectStore(N);await i.put(t,R(e)),await n.done}catch(e){if(e instanceof o.FirebaseError)u.warn(e.message);else{const t=C.create("idb-set",{originalErrorMessage:null==e?void 0:e.message});u.warn(t.message)}}}function R(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var F;F="",m(new(0,i.Component)("platform-logger",(e=>new l(e)),"PRIVATE")),m(new(0,i.Component)("heartbeat",(e=>new A(e)),"PRIVATE")),T(h,c,F),T(h,c,"esm2017"),T("fire-js","")})),s.register("24lia",(function(t,n){e(t.exports,"Component",(()=>r)),e(t.exports,"ComponentContainer",(()=>l));var i=s("hOThH");class r{constructor(e,t,n){this.name=e,this.instanceFactory=t,this.type=n,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const O=function(e){let t={},n={},i={},s="";try{const r=e.split(".");t=R(_(r[0])||""),n=R(_(r[1])||""),s=r[2],i=n.d||{},delete n.d}catch(e){}return{header:t,claims:n,data:i,signature:s}},M=function(e){const t=O(e).claims;return!!t&&"object"==typeof t&&t.hasOwnProperty("iat")},L=function(e){const t=O(e).claims;return"object"==typeof t&&!0===t.admin};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _e=32,fe=768;class ge{constructor(e,t){if(void 0===t){this.pieces_=e.split("/");let t=0;for(let e=0;e<this.pieces_.length;e++)this.pieces_[e].length>0&&(this.pieces_[t]=this.pieces_[e],t++);this.pieces_.length=t,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=t}toString(){let e="";for(let t=this.pieceNum_;t<this.pieces_.length;t++)""!==this.pieces_[t]&&(e+="/"+this.pieces_[t]);return e||"/"}}function me(){return new ge("")}function ye(e){return e.pieceNum_>=e.pieces_.length?null:e.pieces_[e.pieceNum_]}function ve(e){return e.pieces_.length-e.pieceNum_}function Ce(e){let t=e.pieceNum_;return t<e.pieces_.length&&t++,new ge(e.pieces_,t)}function we(e){return e.pieceNum_<e.pieces_.length?e.pieces_[e.pieces_.length-1]:null}function be(e,t=0){return e.pieces_.slice(e.pieceNum_+t)}function Ie(e){if(e.pieceNum_>=e.pieces_.length)return null;const t=[];for(let n=e.pieceNum_;n<e.pieces_.length-1;n++)t.push(e.pieces_[n]);return new ge(t,0)}function Ee(e,t){const n=[];for(let t=e.pieceNum_;t<e.pieces_.length;t++)n.push(e.pieces_[t]);if(t instanceof ge)for(let e=t.pieceNum_;e<t.pieces_.length;e++)n.push(t.pieces_[e]);else{const e=t.split("/");for(let t=0;t<e.length;t++)e[t].length>0&&n.push(e[t])}return new ge(n,0)}function Te(e){return e.pieceNum_>=e.pieces_.length}function Se(e,t){const n=ye(e),i=ye(t);if(null===n)return t;if(n===i)return Se(Ce(e),Ce(t));throw new Error("INTERNAL ERROR: innerPath ("+t+") is not within outerPath ("+e+")")}function ke(e,t){const n=be(e,0),i=be(t,0);for(let e=0;e<n.length&&e<i.length;e++){const t=R(n[e],i[e]);if(0!==t)return t}return n.length===i.length?0:n.length<i.length?-1:1}function Ne(e,t){if(ve(e)!==ve(t))return!1;for(let n=e.pieceNum_,i=t.pieceNum_;n<=e.pieces_.length;n++,i++)if(e.pieces_[n]!==t.pieces_[i])return!1;return!0}function xe(e,t){let n=e.pieceNum_,i=t.pieceNum_;if(ve(e)>ve(t))return!1;for(;n<e.pieces_.length;){if(e.pieces_[n]!==t.pieces_[i])return!1;++n,++i}return!0}class Pe{constructor(e,t){this.errorPrefix_=t,this.parts_=be(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let e=0;e<this.parts_.length;e++)this.byteLength_+=(0,o.stringLength)(this.parts_[e]);De(this)}}function De(e){if(e.byteLength_>fe)throw new Error(e.errorPrefix_+"has a key path longer than "+fe+" bytes ("+e.byteLength_+").");if(e.parts_.length>_e)throw new Error(e.errorPrefix_+"path specified exceeds the maximum depth that can be written ("+_e+") or object contains a cycle "+Re(e))}function Re(e){return 0===e.parts_.length?"":"in property '"+e.parts_.join(".")+"'"}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let qe;class Ue extends Fe{static get __EMPTY_NODE(){return qe}static set __EMPTY_NODE(e){qe=e}compare(e,t){return R(e.name,t.name)}isDefinedOn(e){throw(0,o.assertionError)("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return Le.MIN}maxPost(){return new Le(D,qe)}makePost(e,t){return(0,o.assert)("string"==typeof e,"KeyIndex indexValue must always be a string."),new Le(e,qe)}toString(){return".key"}}const Be=new Ue;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function Ve(e,t){return R(e.name,t.name)}function ze(e,t){return R(e,t)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let $e;He.EMPTY_NODE=new class{copy(e,t,n,i,s){return this}insert(e,t,n){return new je(e,t,null)}remove(e,t){return this}count(){return 0}isEmpty(){return!0}inorderTraversal(e){return!1}reverseTraversal(e){return!1}minKey(){return null}maxKey(){return null}check_(){return 0}isRed_(){return!1}};const Ye=function(e){return"number"==typeof e?"number:"+q(e):"string:"+e},Ke=function(e){if(e.isLeafNode()){const t=e.val();(0,o.assert)("string"==typeof t||"number"==typeof t||"object"==typeof t&&(0,o.contains)(t,".sv"),"Priority must be a string or number.")}else(0,o.assert)(e===$e||e.isEmpty(),"priority of unexpected type.");(0,o.assert)(e===$e||e.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dt=new class extends Fe{compare(e,t){const n=e.node.compareTo(t.node);return 0===n?R(e.name,t.name):n}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return Le.MIN}maxPost(){return Le.MAX}makePost(e,t){const n=ct(e);return new Le(t,n)}toString(){return".value"}};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,((e,i)=>{kt(i,new ge(t.toString()+"/"+e),n)}))}class Nt{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&F(this.last_,((e,n)=>{t[e]=t[e]-n})),this.last_=e,t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xt{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new Nt(e);const n=1e4+2e4*Math.random();j(this.reportStats_.bind(this),Math.floor(n))}reportStats_(){const e=this.statsListener_.get(),t={};let n=!1;F(e,((e,i)=>{i>0&&(0,o.contains)(this.statsToReport_,e)&&(t[e]=i,n=!0)})),n&&this.server_.reportStats(t),j(this.reportStats_.bind(this),Math.floor(2*Math.random()*3e5))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Pt,Dt;function Rt(e){return{fromUser:!1,fromServer:!0,queryId:e,tagged:!0}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bn(e,t,n,i,s){const r=new vn;let a,l;if(n.type===Pt.OVERWRITE){const h=n;h.source.fromUser?a=Tn(e,t,h.path,h.snap,i,s,r):((0,o.assert)(h.source.fromServer,"Unknown source."),l=h.source.tagged||t.serverCache.isFiltered()&&!Te(h.path),a=En(e,t,h.path,h.snap,i,s,l,r))}else if(n.type===Pt.MERGE){const h=n;h.source.fromUser?a=function(e,t,n,i,s,r,o){let a=t;return i.foreach(((i,l)=>{const h=Ee(n,i);Sn(t,ye(h))&&(a=Tn(e,a,h,l,s,r,o))})),i.foreach(((i,l)=>{const h=Ee(n,i);Sn(t,ye(h))||(a=Tn(e,a,h,l,s,r,o))})),a}(e,t,h.path,h.children,i,s,r):((0,o.assert)(h.source.fromServer,"Unknown source."),l=h.source.tagged||t.serverCache.isFiltered(),a=Nn(e,t,h.path,h.children,i,s,l,r))}else if(n.type===Pt.ACK_USER_WRITE){const l=n;a=l.revert?function(e,t,n,i,s,r){let a;if(null!=_n(i,n))return t;{const l=new wn(i,t,s),h=t.eventCache.getNode();let c;if(Te(n)||".priority"===ye(n)){let n;if(t.serverCache.isFullyInitialized())n=un(i,Vt(t));else{const e=t.serverCache.getNode();(0,o.assert)(e instanceof at,"serverChildren would be complete if leaf node"),n=dn(i,e)}c=e.filter.updateFullNode(h,n,r)}else{const s=ye(n);let o=gn(i,s,t.serverCache);null==o&&t.serverCache.isCompleteForChild(s)&&(o=h.getImmediateChild(s)),c=null!=o?e.filter.updateChild(h,s,o,Ce(n),l,r):t.eventCache.getNode().hasChild(s)?e.filter.updateChild(h,s,at.EMPTY_NODE,Ce(n),l,r):h,c.isEmpty()&&t.serverCache.isFullyInitialized()&&(a=un(i,Vt(t)),a.isLeafNode()&&(c=e.filter.updateFullNode(c,a,r)))}return a=t.serverCache.isFullyInitialized()||null!=_n(i,me()),Wt(t,c,a,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Kn=1;class Gn{constructor(e){this.listenProvider_=e,this.syncPointTree_=new $t(null),this.pendingWriteTree_={visibleWrites:Yt.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Qn(e,t,n,i,s){return function(e,t,n,i,s){(0,o.assert)(i>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===s&&(s=!0),e.allWrites.push({path:t,snap:n,writeId:i,visible:s}),s&&(e.visibleWrites=Kt(e.visibleWrites,t,n)),e.lastWriteId=i}(e.pendingWriteTree_,t,n,i,s),s?ri(e,new Mt({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,n)):[]}function Jn(e,t,n,i){!function(e,t,n,i){(0,o.assert)(i>e.lastWriteId,"Stacking an older merge on top of newer ones"),e.allWrites.push({path:t,children:n,writeId:i,visible:!0}),e.visibleWrites=Gt(e.visibleWrites,t,n),e.lastWriteId=i}(e.pendingWriteTree_,t,n,i);const s=$t.fromObject(n);return ri(e,new Lt({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,s))}function Xn(e,t,n=!1){const i=function(e,t){for(let n=0;n<e.allWrites.length;n++){const i=e.allWrites[n];if(i.writeId===t)return i}return null}(e.pendingWriteTree_,t);if(on(e.pendingWriteTree_,t)){let t=new $t(null);return null!=i.snap?t=t.set(me(),!0):F(i.children,(e=>{t=t.set(new ge(e),!0)})),ri(e,new At(i.path,t,n))}return[]}function Zn(e,t,n){return ri(e,new Mt({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,n))}function ei(e,t,n,i,s=!1){const r=t._path,o=e.syncPointTree_.get(r);let a=[];if(o&&("default"===t._queryIdentifier||zn(o,t))){const l=Wn(o,t,n,i);0===o.views.size&&(e.syncPointTree_=e.syncPointTree_.remove(r));const h=l.removed;if(a=l.events,!s){const n=-1!==h.findIndex((e=>e._queryParams.loadsAllData())),s=e.syncPointTree_.findOnPath(r,((e,t)=>$n(t)));if(n&&!s){const t=e.syncPointTree_.subtree(r);if(!t.isEmpty()){const n=function(e){return e.fold(((e,t,n)=>{if(t&&$n(t)){return[Yn(t)]}{let e=[];return t&&(e=jn(t)),F(n,((t,n)=>{e=e.concat(n)})),e}}))}(t);for(let t=0;t<n.length;++t){const i=n[t],s=i.query,r=li(e,i);e.listenProvider_.startListening(_i(s),hi(e,s),r.hashFn,r.onComplete)}}}if(!s&&h.length>0&&!i)if(n){const n=null;e.listenProvider_.stopListening(_i(t),n)}else h.forEach((t=>{const n=e.queryToTagMap.get(ci(t));e.listenProvider_.stopListening(_i(t),n)}))}!function(e,t){for(let n=0;n<t.length;++n){const i=t[n];if(!i._queryParams.loadsAllData()){const t=ci(i),n=e.queryToTagMap.get(t);e.queryToTagMap.delete(t),e.tagToQueryMap.delete(n)}}}(e,h)}return a}function ti(e,t,n,i){const s=ui(e,i);if(null!=s){const i=di(s),r=i.path,o=i.queryId,a=Se(r,t);return pi(e,r,new Mt(Rt(o),a,n))}return[]}function ni(e,t,n,i=!1){const s=t._path;let r=null,a=!1;e.syncPointTree_.foreachOnPath(s,((e,t)=>{const n=Se(e,s);r=r||Hn(t,n),a=a||$n(t)}));let l,h=e.syncPointTree_.get(s);if(h?(a=a||$n(h),r=r||Hn(h,me())):(h=new Fn,e.syncPointTree_=e.syncPointTree_.set(s,h)),null!=r)l=!0;else{l=!1,r=at.EMPTY_NODE;e.syncPointTree_.subtree(s).foreachChild(((e,t)=>{const n=Hn(t,me());n&&(r=r.updateImmediateChild(e,n))}))}const c=zn(h,t);if(!c&&!t._queryParams.loadsAllData()){const n=ci(t);(0,o.assert)(!e.queryToTagMap.has(n),"View does not exist, but we have a tag");const i=Kn++;e.queryToTagMap.set(n,i),e.tagToQueryMap.set(i,n)}let u=Bn(h,t,n,rn(e.pendingWriteTree_,s),r,l);if(!c&&!a&&!i){const n=Vn(h,t);u=u.concat(function(e,t,n){const i=t._path,s=hi(e,t),r=li(e,n),a=e.listenProvider_.startListening(_i(t),s,r.hashFn,r.onComplete),l=e.syncPointTree_.subtree(i);if(s)(0,o.assert)(!$n(l.value),"If we're adding a query, it shouldn't be shadowed");else{const t=l.fold(((e,t,n)=>{if(!Te(e)&&t&&$n(t))return[Yn(t).query];{let e=[];return t&&(e=e.concat(jn(t).map((e=>e.query)))),F(n,((t,n)=>{e=e.concat(n)})),e}}));for(let n=0;n<t.length;++n){const i=t[n];e.listenProvider_.stopListening(_i(i),hi(e,i))}}return a}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ei{constructor(e="",t=null,n={children:{},childCount:0}){this.name=e,this.parent=t,this.node=n}}function Ti(e,t){let n=t instanceof ge?t:new ge(t),i=e,s=ye(n);for(;null!==s;){const e=(0,o.safeGet)(i.node.children,s)||{children:{},childCount:0};i=new Ei(s,i,e),n=Ce(n),s=ye(n)}return i}function Si(e){return e.node.value}function ki(e,t){e.node.value=t,Ri(e)}function Ni(e){return e.node.childCount>0}function xi(e,t){F(e.node.children,((n,i)=>{t(new Ei(n,e,i))}))}function Pi(e,t,n,i){n&&!i&&t(e),xi(e,(e=>{Pi(e,t,!0,i)})),n&&i&&t(e)}function Di(e){return new ge(null===e.parent?e.name:Di(e.parent)+"/"+e.name)}function Ri(e){null!==e.parent&&function(e,t,n){const i=function(e){return void 0===Si(e)&&!Ni(e)}(n),s=(0,o.contains)(e.node.children,t);i&&s?(delete e.node.children[t],e.node.childCount--,Ri(e)):i||s||(e.node.children[t]=n.node,e.node.childCount++,Ri(e))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class $i{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Yi(e,t){let n=null;for(let i=0;i<t.length;i++){const s=t[i],r=s.getPath();null===n||Ne(r,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:r}),n.events.push(s)}n&&e.eventLists_.push(n)}function Ki(e,t,n){Yi(e,n),Qi(e,(e=>Ne(e,t)))}function Gi(e,t,n){Yi(e,n),Qi(e,(e=>xe(e,t)||xe(t,e)))}function Qi(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const s=e.eventLists_[i];if(s){t(s.path)?(Ji(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function Ji(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();w&&E("event: "+n.toString()),W(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class xs{constructor(e,t,n,i){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=i}get key(){return Te(this._path)?null:we(this._path)}get ref(){return new Ps(this._repo,this._path)}get _queryIdentifier(){const e=bt(this._queryParams),t=M(e);return"{}"===t?"default":t}get _queryObject(){return bt(this._queryParams)}isEqual(e){if(!((e=(0,o.getModularInstance)(e))instanceof xs))return!1;const t=this._repo===e._repo,n=Ne(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&n&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+function(e){let t="";for(let n=e.pieceNum_;n<e.pieces_.length;n++)""!==e.pieces_[n]&&(t+="/"+encodeURIComponent(String(e.pieces_[n])));return t||"/"}(this._path)}}class Ps extends xs{constructor(e,t){super(e,t,new Ct,!1)}get parent(){const e=Ie(this._path);return null===e?null:new Ps(this._repo,e)}get root(){let e=this;for(;null!==e.parent;)e=e.parent;return e}}class Ds{constructor(e,t,n){this._node=e,this.ref=t,this._index=n}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new ge(e),n=As(this.ref,e);return new Ds(this._node.getChild(t),n,Ze)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){if(this._node.isLeafNode())return!1;return!!this._node.forEachChild(this._index,((t,n)=>e(new Ds(n,As(this.ref,t),Ze))))}hasChild(e){const t=new ge(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return!this._node.isLeafNode()&&!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Rs(e,t){return(e=(0,o.getModularInstance)(e))._checkNotDeleted("ref"),void 0!==t?As(e._root,t):e._root}function As(e,t){return null===ye((e=(0,o.getModularInstance)(e))._path)?Hi("child","path",t,!1):ji("child","path",t,!1),new Ps(e._repo,Ee(e._path,t))}function Os(e,t){e=(0,o.getModularInstance)(e),Vi("push",e._path),Ui("push",t,e._path,!0);const n=ns(e._repo),i=Ts(n),s=As(e,i),r=As(e,i);let a;return a=null!=t?Ls(r,t).then((()=>r)):Promise.resolve(r),s.then=a.then.bind(a),s.catch=a.then.bind(a,void 0),s}function Ms(e){return Vi("remove",e._path),Ls(e,null)}function Ls(e,t){e=(0,o.getModularInstance)(e),Vi("set",e._path),Ui("set",t,e._path,!1);const n=new(0,o.Deferred);return ls(e._repo,e._path,t,null,n.wrapCallback((()=>{}))),n.promise}function Fs(e,t){Wi("update",t,e._path,!1);const n=new(0,o.Deferred);return function(e,t,n,i){us(e,"update",{path:t.toString(),value:n});let s=!0;const r=is(e),o={};if(F(n,((n,i)=>{s=!1,o[n]=wi(Ee(t,n),ct(i),e.serverSyncTree_,r)})),s)E("update() called with empty data.  Don't do anything."),ds(0,i,"ok",void 0);else{const s=as(e),r=Jn(e.serverSyncTree_,t,o,s);Yi(e.eventQueue_,r),e.server_.merge(t.toString(),n,((n,r)=>{const o="ok"===n;o||N("update at "+t+" failed: "+n);const a=Xn(e.serverSyncTree_,s,!o),l=a.length>0?fs(e,t):t;Gi(e.eventQueue_,l,a),ds(0,i,n,r)})),F(n,(n=>{const i=Cs(e,Ee(t,n));fs(e,i)})),Gi(e.eventQueue_,t,[])}}(e._repo,e._path,t,n.wrapCallback((()=>{}))),n.promise}function qs(e){e=(0,o.getModularInstance)(e);const t=new Ns((()=>{})),n=new Us(t);return function(e,t,n){const i=si(e.serverSyncTree_,t);return null!=i?Promise.resolve(i):e.server_.get(t).then((i=>{const s=ct(i).withIndex(t._queryParams.getIndex());let r;if(ni(e.serverSyncTree_,t,n,!0),t._queryParams.loadsAllData())r=Zn(e.serverSyncTree_,t._path,s);else{const n=hi(e.serverSyncTree_,t);r=ti(e.serverSyncTree_,t._path,s,n)}return Gi(e.eventQueue_,t._path,r),ei(e.serverSyncTree_,t,n,null,!0),s}),(n=>(us(e,"get for query "+(0,o.stringify)(t)+" failed: "+n),Promise.reject(new Error(n)))))}(e._repo,e,n).then((t=>new Ds(t,new Ps(e._repo,e._path),e._queryParams.getIndex())))}class Us{constructor(e){this.callbackContext=e}respondsTo(e){return"value"===e}createEvent(e,t){const n=t._queryParams.getIndex();return new Ss("value",this,new Ds(e.snapshotNode,new Ps(t._repo,t._path),n))}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new ks(this,e,t):null}matches(e){return e instanceof Us&&(!e.callbackContext||!this.callbackContext||e.callbackContext.matches(this.callbackContext))}hasAnyCallback(){return null!==this.callbackContext}}class Bs{constructor(e,t){this.eventType=e,this.callbackContext=t}respondsTo(e){let t="children_added"===e?"child_added":e;return t="children_removed"===t?"child_removed":t,this.eventType===t}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new ks(this,e,t):null}createEvent(e,t){(0,o.assert)(null!=e.childName,"Child events should have a childName.");const n=As(new Ps(t._repo,t._path),e.childName),i=t._queryParams.getIndex();return new Ss(e.type,this,new Ds(e.snapshotNode,n,i),e.prevName)}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof Bs&&(this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)))}hasAnyCallback(){return!!this.callbackContext}}function Ws(e,t,n,i,s){let r;if("object"==typeof i&&(r=void 0,s=i),"function"==typeof i&&(r=i),s&&s.onlyOnce){const t=n,i=(n,i)=>{hs(e._repo,e,a),t(n,i)};i.userCallback=n.userCallback,i.context=n.context,n=i}const o=new Ns(n,r||void 0),a="value"===t?new Us(o):new Bs(t,o);return function(e,t,n){let i;i=".info"===ye(t._path)?ni(e.infoSyncTree_,t,n):ni(e.serverSyncTree_,t,n),Ki(e.eventQueue_,t._path,i)}(e._repo,e,a),()=>hs(e._repo,e,a)}function js(e,t,n,i){return Ws(e,"value",t,n,i)}!function(e){(0,o.assert)(!Mn,"__referenceConstructor has already been defined"),Mn=e}(Ps),function(e){(0,o.assert)(!Ln,"__referenceConstructor has already been defined"),Ln=e}(Ps);
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Qs=i.SDK_VERSION,u=Qs,(0,i._registerComponent)(new(0,r.Component)("database",((e,{instanceIdentifier:t})=>$s(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),(0,i.registerVersion)(h,c,Gs),(0,i.registerVersion)(h,c,"esm2017")})),s.register("lita1",(function(t,n){e(t.exports,"DisplayToDom",(()=>i));class i{hideRegisterElements(){document.querySelector("#gender-choice").style.display="none";document.querySelector("#user-bio").style.display="none";document.querySelector("#register-user").style.display="none"}fillInEveryBlock(){document.getElementById("title").innerText="Fill all inputs"}wrongUserOrPassword(){document.getElementById("title").innerText="Wrong username or password"}doesntExist(){document.getElementById("title").innerText="User doesn't exist."}alreadyUser(){document.getElementById("title").innerText="Username already exists, choose another"}hideAndShowLoginPage(){document.getElementById("register").addEventListener("click",(e=>{e.preventDefault();const t=document.getElementById("form-title-container"),n=document.getElementById("login-title"),i=document.getElementById("username"),s=document.getElementById("password-title"),r=document.querySelector("#gender-choice"),o=document.getElementById("password"),a=document.getElementById("login"),l=document.getElementById("register"),h=document.querySelector("#user-bio"),c=document.querySelector("#register-user"),u=document.querySelector("#userIMG");u.style.display="block",c.style.display="center",n.style.display="center",i.style.display="center",o.style.display="center",i.value="",o.value="",t.style.height="900px",a.style.display="none",r.style.display="block",h.style.display="block",n.innerText="Choose a username",s.innerText="Type password",c.style.display="block",l.innerHTML='Already registered? <a id="return" href="">Click here</a>',document.getElementById("return").addEventListener("click",(e=>{e.preventDefault(),e.stopPropagation(),r.style.display="none",h.style.display="none",n.innerText="Log in",i.value="",o.value="",s.style.display="none",c.style.display="none",a.style.display="revert",l.style.display="center",u.style.display="none",t.style.height="500px",l.innerHTML='No account? <a id="return" href="">Register here</a>'}))}))}}}));
//# sourceMappingURL=forumGames.a7b23ab2.js.map
